...
export default function DocsPage() {
  return (
    <main className="mx-auto max-w-7xl px-6 py-16">
      <div className="mb-6">
        <p className="mb-2 text-sm font-semibold uppercase tracking-[0.28em] text-[#6B7280]">
          Architecture
        </p>
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-slate-100 bg-white p-5 shadow-card">
          <h2 className="text-sm font-semibold text-slate-900">Read paths</h2>
        ...
        <div className="rounded-xl border border-slate-100 bg-white p-5 shadow-card">
          <h2 className="text-sm font-semibold text-slate-900">Write paths</h2>
          <p className="mt-2 text-xs leading-relaxed text-slate-600">
        ...
        <div className="rounded-xl border border-slate-100 bg-white p-5 shadow-card">
          <h2 className="text-sm font-semibold text-slate-900">Integrity</h2>
          <p className="mt-2 text-xs leading-relaxed text-slate-600">
